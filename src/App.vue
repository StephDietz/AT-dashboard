  ...
  <div class="bg-darkest min-h-screen">
    ...
    <div class="container bg-dark rounded-lg my-12">
      ...
      <div class="flex items-center">
        <button @click="type = 'member'" :class="`focus:outline-none w-1/2 p-5 ${ type === 'member' ? 'bg-chosen border-t border-blue-700' : ''}`" style="border-radius:8px 8px 0px 0px;">
          <h1 class="text-sm uppercase text-gray-400">Member (Dummy Data)</h1>
        </button>
        <button @click="type = 'operational'" :class="`focus:outline-none w-1/2 p-5 ${ type === 'operational' ? 'bg-chosen border-t border-blue-700' : ''}`" style="border-radius:8px 8px 0px 0px;">
...
export default {
  ...
  data: function() {
    return {
      ...
      oneYear: false,
      stats: [
        {type: 'member', title: 'Member Use Overall Population', number: '12', numberOld: '11', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah what if this one is waaay lonher than the others how will it fit.', show: false },
        {type: 'member', title: 'Member Ratio with Anthem Anywhere', number: '33', numberOld: '30', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'member', title: 'Member Re-Use', number: '65', numberOld: '68', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false },
        {type: 'member', title: 'Member Success Rate', number: '85', numberOld: '70', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'member', title: 'Member Success Rate 1st Conversation', numberOld: '70', number: '69', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'member', title: 'Member Re-Use based on Success/Failure', number: '63', numberOld: '63', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'operational', title: 'Updated Impact Change for Fixes', number: '81', numberOld: '70', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'operational', title: 'Ambiguous Rate', number: '72', numberOld: '70', unit: '%', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false},
        {type: 'operational', title: 'Avg Response Time', number: '3', numberOld: '3', unit: 'sec.', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false },
        {type: 'operational', title: 'Number of Re-Directs Post Success', number: '46', numberOld: '40', unit: '', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false },
        {type: 'operational', title: 'App Ratings', number: '4.7', numberOld: '4.6', unit: '', date: '8/10/2019', description: 'Whatever the description of this is blah blah blah.', show: false}
      ]
    };
  },
  computed: {
